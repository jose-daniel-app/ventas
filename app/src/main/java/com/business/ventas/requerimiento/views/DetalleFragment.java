...
public class DetalleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //toolbar.inflateMenu(R.menu.detalle_menu);
    ...
    public DetalleFragment setNavigationView(NavigationView navigationView) {
        this.navigationView = navigationView;
        return this;
    }

    public DetalleFragment setToolbar(Toolbar toolbar) {
